...
public class TestEntity {
    ...
    //Хорошая практика сохранять время как момент, в UTC. Очень редко (практически никогда) нужно
    //знать с каким сдвигом пришло в БД время, т.е. из какой часовой зоны оно пришло.
    //Если вдруг это понадобится, то можно написать свой дескриптор TimestampTypeDescriptor, где использовать
