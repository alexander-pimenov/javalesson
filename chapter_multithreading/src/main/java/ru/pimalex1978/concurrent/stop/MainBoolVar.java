 ...
 * когда он может это сделать. Он доведет свои дела до логического конца
 * и безопасно остановится.
 *
 */
public class MainBoolVar {
     ...
     * условие. Он будет висеть. Программа зависнет. Не смотря на то, что
    ...
    public static void main(String[] args) {
        ...
        Thread worker = new Thread(new Runnable() {
            ...
            public void run() {
                 ...
                 * ему приходят, пока проверочная переменная isStopped
                 * будет false.
         ...
         * сможет завершиться.*/
        for (int i = 0; i < 5; i++) {
            /* Генерируем объект Runnable методом getTask()
        ...
        /* Здесь isStopped поменяет значение на true, т.е. через 3 сек
         * после запуска worker и произойдет остановка потока worker,
         * ну и потока main и самой программы.
         * */
        isStopped = true;
    }
