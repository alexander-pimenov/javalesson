package duke; /******************************************************************************
 *  Compilation:  javac duke.StdDraw.java
 *  Execution:    java duke.StdDraw
 *  Dependencies: none
 *
...
/**
 *  <p><b>Overview.</b>
 *  The {@code duke.StdDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code duke.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">duke.StdDraw.java</a>
 ...
 *           duke.StdDraw.setPenRadius(0.05);
 *           duke.StdDraw.setPenColor(duke.StdDraw.BLUE);
 *           duke.StdDraw.point(0.5, 0.5);
 *           duke.StdDraw.setPenColor(duke.StdDraw.MAGENTA);
 *           duke.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code duke.StdDraw.line()} and {@code duke.StdDraw.point()}
 *  draw lines and points; the methods {@code duke.StdDraw.setPenRadius()}
 *  and {@code duke.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code duke.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   duke.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code duke.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code duke.StdDraw.setPenColor(duke.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code duke.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code duke.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   duke.StdDraw.setFont(font);
 *   duke.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code duke.StdDraw.clear(duke.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   duke.StdDraw.setScale(-2, +2);
 *   duke.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       duke.StdDraw.clear();
 *       duke.StdDraw.filledCircle(x, y, 0.05);
 *       duke.StdDraw.filledCircle(-x, -y, 0.05);
 *       duke.StdDraw.show();
 *       duke.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * {@code duke.StdDraw.BLACK}, {@code duke.StdDraw.BLUE}, {@code duke.StdDraw.CYAN},
     * {@code duke.StdDraw.DARK_GRAY}, {@code duke.StdDraw.GRAY}, {@code duke.StdDraw.GREEN},
     * {@code duke.StdDraw.LIGHT_GRAY}, {@code duke.StdDraw.MAGENTA}, {@code duke.StdDraw.ORANGE},
     * {@code duke.StdDraw.PINK}, {@code duke.StdDraw.RED}, {@code duke.StdDraw.WHITE}, and
     * {@code duke.StdDraw.YELLOW}.
     *
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to duke.StdDraw)
        if (icon.getImageLoadStatus() != MediaTracker.COMPLETE) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to duke.StdDraw)
        try {
            URL url = duke.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        }
        catch (IOException e) {
