...
/**
 * Хорошее обучающее видео о логировании <a href="https://www.youtube.com/watch?v=N4fmELeXw5I">ссылка</a>
 ...
 * В нем рассказывется для чего логирование и, кратко, об его уровнях: TRACE, INFO, DEBUG, WARN, ERROR.
 ...
 *
 * <p>
 * Этот класс обращается к файлу log4j.properties (log4j.xml) для правильного вывода информации в консоль,
 * * т.е. это файл настройки вывода лога.
 * <p>
 * Касаемо вопроса по-поводу уровней логирования. То негласные договоренности такие:
 * <p>
...
public class UsageLog4j {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            LOG.error("Error message from catch-block. Failed to read file {}.", FILENAME, ex);
