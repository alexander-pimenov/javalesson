 ...
 * Промежуточные операции (операции трансформации) не вызываются в тот
...
public class StreamsTest {
    ...
    /**
     * Рассмотрим методы по созданию стримов.
     *
     * @throws IOException исключение от Files.
     */
    @Test
    public void creation() throws IOException {
        //Попробуем создать стримы из объектов файловой системы
